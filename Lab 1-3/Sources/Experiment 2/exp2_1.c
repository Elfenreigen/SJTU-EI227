...
{  
	static uint8_t ui8KeyCurState = 0;  //保存最近一次检测到的按键状态
	uint8_t ui8KeyPreState = ui8KeyCurState;  //保存前一次检测到的按键状态
	key_code = TM1638_Readkeyboard();
	
	if (key_code == 0) ui8KeyCurState = 0;
	else ui8KeyCurState = 1;
